...
while continuar == 's':
    ...
    # Solicitar ao usuário que digite o valor do seu salário e converter a entrada para um número flutuante
    ...
    # Solicitar ao usuário que digite a porcentagem do bônus recebido e converter a entrada para um número flutuante
    ...
    if nome not in usuarios:
        usuarios[nome] = {'Nome': nome, 'Salário': salario, 'Bônus': bonus, 'Valor bônus': kpi}
    else:
